...
public:
    ...
    typedef enum
    {
    	Bw500Cr45 = 91,		///< Bw = 500 kHz, Cr = 4/5, 
    	Bw500Cr46,			///< Bw = 500 kHz, Cr = 4/6, 
    	Bw500Cr47,			///< Bw = 500 kHz, Cr = 4/7, 
    	Bw500Cr48,			///< Bw = 500 kHz, Cr = 4/8, 
    }Reg1DModemConfig;
    ...
    /// This function adjusts the Coding Rate.
    /// The Coding Rate is also set in the init function
    /// Coding Rate is a forward error correction mechanisim for the LoRa transmission
    /// The Coding Rate has to be adjustied together with the Bandwidth
    /// please look in the documentation -> register 1D to find all possible adjustments
    /// This function sets the modul in explicit mode (with header)
    void setBandwidthAndCodingRate(Reg1DModemConfig bwCr);
